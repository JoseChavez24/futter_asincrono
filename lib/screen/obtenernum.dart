          ...
          title: Center(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    const SizedBox(height: 40),botonVerde(),const SizedBox(height: 6),box(),Text(
                      "$obtenernum1",
                    ...
                    const SizedBox(height: 6),botonOrange(),const SizedBox(height: 6),boxorange(),Text(
                      "$obtenernum2",
                      style: const TextStyle(
                        color: Colors.orange,
                        fontSize: 50,
                    ...
                    const SizedBox(height: 6),botonRed(),const SizedBox(height: 6),boxred(),Text(
                      "$obtenernum3",
                      style: const TextStyle(
                        color: Colors.red,
                        fontSize: 50,
